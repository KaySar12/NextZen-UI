      ...
      <section class="modal-card-body" :class="bodyPadding">
        <template v-if="state == 1">
          <div class="is-flex is-justify-content-center mb-5">
            <div class="is-relative">
              ...
              <b-image
                :src="avatarUrl"
                :src-fallback="require('@/assets/img/account/ava.svg')"
                class="is-80x80"
                rounded
              ></b-image>
            </div>
          ...
          <div class="mb-55">
            ...
            <div class="is-flex is-align-items-center ">
              ...
              <!-- <div class="edit-button" @click.stop="goto(2)">
                <b-icon
                  class="close-button ml-2 has-text-gray-font"
                  icon="edit-outline"
                  pack="casa"
                />
              </div> -->
          ...
          <!-- <div>
            <div class="has-text-emphasis-04 has-text-gray-font mb-2">app-Files
              {{ $t("Password") }}
            </div>
          ...
          <ValidationProvider v-slot="{ errors, valid }" name="User" rules="required">
            ...
            >
              <b-input
                ...
                type="text"
                v-on:keyup.enter.native="handleSubmit(saveUser)"
              ></b-input>
            </b-field>
          </ValidationProvider>
        </template>
        ...
        <template v-else-if="state == 3">
          ...
          >
            ...
            >
              <b-input
                v-model="oriPassword"
                :placeholder="$t('Original password')"
                password-reveal
                type="password"
              ></b-input>
            </b-field>
          ...
          >
            ...
            >
              <b-input
                ...
                :placeholder="$t('Confirm the new password again')"
                password-reveal
                type="password"
                v-on:keyup.enter.native="savePassword(savePassword)"
              ></b-input>
            </b-field>
          </ValidationProvider>
        </template>
        ...
        <template v-else-if="state == 4">
          <div class="is-flex">
            ...
            <div
              class="is-flex is-justify-content-right is-align-items-center is-flex-grow-1"
            >
...
export default {
  ...
  data() {
    return {
      ...
      avatarUrl: JSON.parse(localStorage.user).avatar || "",
      oriPassword: "",
      password: "",
      confirmation: "",
      message: "",
