...
<template>
  <div id="login-page" class="is-flex is-justify-content-center is-align-items-center">
    <div
      v-if="!isLoading"
      v-animate-css="initAni"
      :class="'step' + step"
      class="login-panel is-shadow"
    >
      <div v-if="step == 1" class="has-text-centered">
        <div v-animate-css="s1Ani" class="is-flex is-justify-content-center">
          <b-image
            :src="require('@/assets/img/logo/nextzen-dark.png')"
            class="is-128x128 mb-4"
          ></b-image>
        </div>

        <h2
          v-animate-css="s2Ani"
          class="title is-2 mb-5 has-text-centered __attached_title"
        >
      ...
      <div v-if="step == 2">
        ...
        <div class="is-flex is-justify-content-center">
          <div class="has-text-centered">
            <b-image
              :src="require('@/assets/img/account/ava.svg')"
              class="is-128x128"
              rounded
            ></b-image>
          </div>
          ...
          .then((res) => {
            if (res.data.success == 200) {
              this.login().then(() => {
                ...
                this.$api.users.setCustomStorage("app_order", {
